      ...
      <div class="container">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			<div class="container">
              ...
              <div class="form-group">
                <textarea name="yourMessage"  id="" cols="30" rows="7" class="form-control" placeholder="Message"></textarea>
                  <span style="color: red"> <?php echo $messageError; ?></span>
              </div>
              <div class="form-group">
                <input name="sub" type="submit" value="Send Message" class="btn btn-primary py-3 px-5">
              </div>
            </form>
					</div>
